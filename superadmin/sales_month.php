  ...
  <div class="modal fade" id="customer_edit" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <thead>
            <tr>
                 <th>Start Date of the Month</th>
                 <th>End Date of the Month</th>
        ...
        include "../connection.php";
          ...
          $sql = "SELECT MONTHNAME(date1) as month, YEAR(date1) as year, DAY(date1) as day, LAST_DAY(date1) as last, SUM(amount) AS total FROM received_payment GROUP BY YEAR(date1), MONTH(date1)";
