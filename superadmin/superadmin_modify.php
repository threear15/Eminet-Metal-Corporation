              ...
              echo'
                ...
                ';
                  ...
                  if (isset($_POST['btn-edit'])) {
                    $id = $_POST['id'];
                    $_SESSION['edit_id_admin'] = $id;
                    echo"
                    <script>window.location.href='edit_superadmin.php';</script>
                    ";
                  }
                  if (isset($_POST['btn-update-password'])) {
                    ...
                    $_SESSION['edit_id_admin'] = $id;
                    echo"
                    <script>window.location.href='password_superadmin.php';</script>
                    ";
                  }if(isset($_POST['btn-delete'])){
                    $id = $_POST['id'];
                    $_SESSION['edit_id_admin'] = $id;
                    $id1 = $_SESSION['edit_id_admin'];
