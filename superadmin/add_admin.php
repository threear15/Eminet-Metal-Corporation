            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">
                 Add Admin<a href="customer_modify.php" class="fa fa-fw fa-times" style="float:right;"></a>
                </h3>
              </div>
              <div class="panel-body">
                <form method="POST">
                  <div class="row">
                    ...
                    <div class="col-md-4"><label>First Name</label><input type="text" class="form-control" name="f_name" ></div>
                    <div class="col-md-4"><label>Middle Name</label><input type="text" class="form-control" name="m_name" ></div>
                    <div class="col-md-4"><label>Last Name</label><input type="text" class="form-control" name="l_name" ></div>
                  </div>
                  <div class="row">
                  ...
                  <option>Female</option>
                    ...
                    <div class="col-md-4"><label>Age</label><input type="text" class="form-control" name="age" ></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6"><label>User Name</label><input type="text" class="form-control" name="user" ></div>
                    <div class="col-md-6"><label>Password</label><input type="password" class="form-control" name="pass" ></div>
                  </div>
                  
                  <div><br></div>
                  <form method="POST">
                  <div>
                     <button type="submit" name="btn_add_admin" class="btn btn-success">ADD ADMIN</button>
                    
            
                  </div>
                  <?php 
            include "add_admin_function.php";
