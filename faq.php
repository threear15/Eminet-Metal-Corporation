...
<div id="msgforgot"></div>
        ...
        <div id="get_faq_msg"></div>
    <!--<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse1"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Pwede Ba Mag Refund?</i></a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse">
        <div class="panel-body"><b>Hindi Pwede Baka kasi malugi kami. Exchange of goods lang ang maibibigay namin'g konsiderasyon at Kung bibili ka Siguraduhin mo na. Wala ng bawian. TIME!</b></div>
      </div>
    </div>-->
    <!--<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse2"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Nagbibigay ba kayo ng warranty?</i></a>
        </h4>
      </div>
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body"><b>Oo nagbibigay kami ng warranty kung ka close kita :P. Charot
          Di po kami nagbibigay ng warranty! Time!</b></div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse3"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Paano kung may sirang product yung dinilivered ninyo, mapalitan ba agad yun?</i></a>
        </h4>
      </div>
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body">
          <b>Dadaan po muna sa masusing pag-aaral yan. Pag napatunayan ng produkto namin yan at napatunayan ng mayroong gasgas o sira ang produkto na dinilivered namin. Agad po namin iyang papalitan. May kasama pang kiss kay Three Ar :*. Time!</b>
        </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse4"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Paano kung na-flatan o naabutan ng bagyo o nabangga wag naman sana... yung sasakyan na gamit niyo pang delivered, anong aksyon ang gagawin ninyo?</i></a>
        </h4>
      </div>
      <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body">
          <b>Agad po kayong kokontakin ng kompanya namin at bibigyan ng abiso ng madedelay yung podukto na inorder ninyo dahil sa kadahilanang hindi malamang dahilan. At nasa pag uusap na po ng kompanya at kostumer ang agreement. Time!</b>
        </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse5"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Puwede ko bang i-kansel yung inorder kong produkto?</i></a>
        </h4>
      </div>
      <div id="collapse5" class="panel-collapse collapse">
        <div class="panel-body">
          <b>Puwede niyo pong I-kansel yung produkto na inorder ninyo. Pero di na ma re-refund yung pera ninyo :P.Kaya kung ako sayo wag mo na ipa-kansel. kasi sayang. Time!</b>
        </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="tryit_121.htm#collapse6"><span class="fa fa-arrow-circle-down"></span>&nbsp;<i>Ilan ang minimum price ng puwede naming ma-avail sa pag order ng products?</i></a>
        </h4>
      </div>
