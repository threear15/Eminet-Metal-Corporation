...
<body>
	...
	<div class="wrapper">
        ...
        <input type="hidden" class="form-control"  placeholder="username" id="role" value="Admin"/>
			  <br>
			  <input type="password" class="form-control"  placeholder="password"  id="pass"/>     		  
			 
			  <button class="btn btn-lg btn-primary btn-block" id="login_admin11" >Login</button>  			
		</form>			
	</div>
</div>
</body>
