                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        include "connection/connection.php";
                          $sql = "SELECT * FROM archived_product";
                          ...
                          while($row = mysqli_fetch_array($run_query)){
                            ...
                            echo"
                            <tr>
                          <td><img src='$p_image' style='width:150px;height:100px;'></td>
                          <td>$p_code</td>
                          <td>$p_name</td>
                          <td>$p_cat</td>
                          <td>$p_price</td>
                          ...
                          <button class='btn btn-danger btn-xs' name='btn-restore'>Restore</button>
                          </td>
                          </form>
                        </tr>
                            ";
                            ...
                            $sql = "INSERT INTO `product` (`product_id`, `product_code`, `product_cat1`, `product_name`, `product_headstyle`, `product_pieces`, `product_color`, `product_price`, `product_size`, `product_image`, `product_stocks`) 
                                    VALUES ('$pid', '$p_code', '$p_cat', '$p_name', '$p_style', '$p_pieces', '$p_color',
                                                 '$p_price', '$p_size', '$p_image', '$p_quantity')";
                            $run_query = mysqli_query($con,$sql);
                            if($run_query){
                              $sql = "DELETE FROM archived_product WHERE id=".$_SESSION['restore_id'];
                              $run_query = mysqli_query($con,$sql);
                              if($run_query){
                                  echo "
                                <script>
                                setTimeout(function() {
                                  ...
                                  swal({
                                    ...
                                    confirmButtonText: 'Success!'
                                      ...
                                      window.location = 'archived-product.php';
                                  });
                                 }, 1);
                                </script>
                              ";
