  ...
  <body class="nav-md">
   ...
   <div id="add_product_msg"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="modal fade" id="modal_edit_admin1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Admin's Edit Form</h4>
        </div>
        <div class="modal-body">
          <div class="x_content">
                    <br />
                    <?php 
                      include "action/admin_modify_edit_function.php";
                      edit_view_admin();
                     ?>
                  </div>        </div>
