  ...
  <body class="nav-md">
   ...
   <div id="add_product_msg"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <tbody>
                       <?php 
                        include "connection/connection.php";
                          ...
                          $sql = "SELECT * FROM cod_tbl";
                          $run_query = mysqli_query($con,$sql);
                          while($row=mysqli_fetch_array($run_query)){
                            $id = $row['id'];
                             $uid = $row['uid'];
                            $receipt = $row['image_receipt'];  
                            $date = $row['date'];                      
                            echo"
                             <tr>
                             <form method='POST'>
                            ...
                            <button class='btn btn-success btn-xs' name='btn-view'>View</button>
                            <button class='btn btn-danger btn-xs'>Delete</button>
                                ...
                                $id = $_POST['id'];
                                $_SESSION['receipt_id'] = $id;
                                echo'
                                <script>window.location.href="cod_modal.php";</script>
                                ';
                              }                         
                        ?>   
                      </tbody>
              ...
              <div id="1">
              <div class="modal fade" id="modal_cod" role="dialog">
    <div class="modal-dialog modal-lg">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <a href="palawan_express.php" style="font-size:20px;font-weight:bold;float:right;">&times;</a>
          <h4 class="modal-title">Image Receipt</h4>
        </div>
        <div class="modal-body">
          <?php
            include "connection/connection.php";
            GLOBAL $con;
            $id = $_SESSION['receipt_id']; 
            $sql = "SELECT * FROM palawan_express_tbl WHERE id = '$id'";
            $run_query = mysqli_query($con,$sql);
            while ($row = mysqli_fetch_array($run_query)){
              $id = $row['id'];
              $receipt = $row['image_receipt'];
              echo"
                 <div> <img src='../$receipt' style='width:860px;'></div>
              ";
            }
           ?>
...
var DocumentContainer = document.getElementById('1');
