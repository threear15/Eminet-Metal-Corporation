                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        include "connection/connection.php";
                          ...
                          <center><button class='btn btn-success btn-xs' name='btn-edit'>Edit</button>
                          <button class='btn btn-warning btn-xs' name='btn-change'>New Password</button>
                          </td>
                          </form>
                        </tr>
                            ";
                            ...
                            $_SESSION['edit_id'] = $id;
                            echo"
                            <script>window.location.href='customer_modify_edit.php';</script>
                            ";
                          }if(isset($_POST['btn-change'])){
                            $id = $_POST['id'];
                            $_SESSION['customer_password'] = $id;
                            echo"
                            <script>window.location.href='customer_modify_password.php';</script>
                            ";
                          }
                         ?>
