        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo $_SESSION['f_name'];?>&nbsp;&nbsp;<?php echo $_SESSION['m_name'];?>&nbsp;&nbsp;<?php echo $_SESSION['l_name'];?></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class='row'>
                    <div class='col-md-4'>
                      <form method="POST" name="data" enctype="multipart/form-data" >  
                          <img src='<?php echo $_SESSION['image'];?>' width='300' height='300'><br><br>
                        <input type='file' name='image1' name='image1' required><br>
                     <button name='btn_upload_image' class='btn btn-success'>UPLOAD IMAGE</button>
                     <a href="" id='refresh'><span style="font-size:20px;"class='fa fa-refresh'></span></a>

                     <?php  
                      include "action/superadmin_function1.php";
                      admin_picture();
                      ?>
                      </form>
                    ...
                    <div class='col-md-8'>
                      ...
                      <?php  
                     include "action/superadmin_get_info_function.php";
                      get_admin_info();
                      ?>
