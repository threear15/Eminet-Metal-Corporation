  ...
  <body class="nav-md">
   ...
   <div id="add_product_msg"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="modal fade" id="modal_edit_product_product" role="dialog">
    <div class="modal-dialog">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <a href="edit-product.php" style="font-size:20px;font-weight:bold;float:right;">&times;</a>
          <h4 class="modal-title">Product's Edit Form</h4>
        </div>
        <div class="modal-body">
          <div class="x_content">
                    <br />
                      ...
                      <!-- FORM -->
                      <?php 
                        include "action/admin_modify_edit_product_function.php";
                        edit_view_product();
                       ?>
...
<script type="text/javascript">
    $(window).on('load',function(){
        $('#modal_edit_product_product').modal('show');
    });
</script>
<?php
