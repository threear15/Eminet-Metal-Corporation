...
<div class="modal fade" id="modal_edit_customer1" role="dialog">
    <div class="modal-dialog">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <a href="customer_modify.php" style="font-size:20px;font-weight:bold;float:right;">&times;</a>
          <h4 class="modal-title">Customer's Edit Form</h4>
        </div>
        <div class="modal-body">
          <div class="x_content">
                    <br />
                    <?php 
                    include "action/customer_modify_edit_function.php";
                    edit_view_customer();
                     ?>
                  </div>        </div>
...
<script type="text/javascript">
    $(window).on('load',function(){
        $('#modal_edit_customer1').modal('show');
    });
</script>
<?php
