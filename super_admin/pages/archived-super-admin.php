                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        include "connection/connection.php";
                          $sql = "SELECT * FROM archived_superadmin WHERE role = 'Super Admin'";
                          ...
                          <button class='btn btn-danger btn-xs' name='btn-restore'>Restore</button>
                            ...
                            $sql = "INSERT INTO `super_admin` (`id`, `role`, `f_name`, `m_name`, `l_name`, `age`, `gender`, `username`,`password`)
                                     VALUES ('$id', '$role', '$f_name', '$m_name', '$l_name', '$age', '$gender', '$username','$password')";
                            $run_query = mysqli_query($con,$sql);
                            if($run_query){
                              $sql = "DELETE FROM archived_superadmin WHERE id=".$_SESSION['delete_id'];
                              $run_query = mysqli_query($con,$sql);
                              if($run_query){
                                  echo "
                                <script>
                                setTimeout(function() {
                                  ...
                                  swal({
                                    ...
                                    confirmButtonText: 'Success!'
                                      ...
                                      window.location = 'archived-super-admin.php';
                                  });
                                 }, 1);
                                </script>
                              ";
