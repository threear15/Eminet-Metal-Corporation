                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        include "connection/connection.php";
                          ...
                          <button class='btn btn-success btn-xs' name='btn-edit'  data-toggle='modal' data-target='#modal_edit_admin'>Edit</button>
                          ...
                          <button class='btn btn-danger btn-xs' name='btn-delete'>Delete</button>
                            ...
                            $_SESSION['edit_id'] = $id;
                            echo"
                            <script>window.location.href='admin_modify_edit.php';</script>
                            ";
                            ...
                            $sql = "INSERT INTO `archived_superadmin` (`id`, `role`, `f_name`, `m_name`, `l_name`, `age`, `gender`, `username`,`password`)
                                     VALUES ('$id', '$role', '$f_name', '$m_name', '$l_name', '$age', '$gender', '$username','$password')";
                            $run_query = mysqli_query($con,$sql);
                            if($run_query){
                              $sql = "DELETE FROM super_admin WHERE id=".$_SESSION['delete_id'];
                              $run_query = mysqli_query($con,$sql);
                              if($run_query){
                                  echo "
                                <script>
                            ...
                            $id = $_POST['id'];
                            $_SESSION['edit_pass'] = $id;
                            echo "
                              <script>
                                window.location.href='admin_modify_password.php';
                                </script>
                                ";
                          }
