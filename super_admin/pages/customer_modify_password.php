  ...
  <body class="nav-md">
   ...
   <div id="add_product_msg"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="modal fade" id="modal_edit_password_customer" role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <a href="customer_modify.php" style="font-size:20px;font-weight:bold;float:right;">&times;</a>
                    ...
                    <br />
                    <?php 
                      include "action/customer_modify_password_function.php";
                      view_password_customer();
                     ?>
                  </div>        </div>
...
<script type="text/javascript">
    $(window).on('load',function(){
        $('#modal_edit_password_customer').modal('show');
    });
</script>
<?php
