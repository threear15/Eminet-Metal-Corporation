	...
	<div class="header">
			...
			<a href="#" class="nav-trigger" ><span></span></a>
				<nav>
							...
							<a href="#" id="go" data-toggle="modal" data-target="#myModal1" style="padding-top:2px;">
							<span><img src="../images/avatar3.png" style="width:60px;height:38px;"></i></span>
		...
		<div class="main-content" id="main_profile">
			<div class="title" id="title_profile">
				...
				<div class="col-md-12">
					<div class="panel panel-info">
						...
						<div class="panel-body" style="background-color:#d5dae5;">
							<div class="row">
								<div class="col-md-4">
									<img src="../images/avatar3.png" style="width:60px;height:60px;">
								</div>
							</div>
						</div>
						<div class="panel-heading"  style="background-color:#233245;"></div>
